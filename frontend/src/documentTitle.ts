...
const ROUTE_TITLES: Array<{ path: string; key: MessageKey; end?: boolean }> = [
  ...
  { path: '/knowledge-base/notes', key: 'titles.notes' },
  { path: '/knowledge-base/zabbix', key: 'titles.zabbixData' },
